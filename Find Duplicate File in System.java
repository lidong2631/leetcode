    ...
    public List<List<String>> findDuplicate(String[] paths) {
        ...
        for (String path : paths) {
            ...
            for (int i = 1; i < strs.length; i++) {
                String fileName = dir + "/" + strs[i].substring(0, strs[i].indexOf("("));
                String fileContent = strs[i].substring(strs[i].indexOf("("), strs[i].indexOf(")"));
...
https://leetcode.com/problems/find-duplicate-file-in-system/discuss/
